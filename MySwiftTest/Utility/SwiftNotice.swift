...
extension UIResponder {
    ...
    @discardableResult
    func noticeTop(_ text: String, autoClear: Bool = true, autoClearTime: Double = 1.0) -> UIWindow{
        return SwiftNotice.noticeOnStatusBar(text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    
    // new apis from v3.3
    @discardableResult
    func noticeSuccess(_ text: String, autoClear: Bool = false, autoClearTime: Double = 3.0) -> UIWindow{
        return SwiftNotice.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeError(_ text: String, autoClear: Bool = false, autoClearTime: Double = 3.0) -> UIWindow{
        return SwiftNotice.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeInfo(_ text: String, autoClear: Bool = false, autoClearTime: Double = 3.0) -> UIWindow{
    ...
    @discardableResult
    func notice(_ text: String, type: NoticeType, autoClear: Bool, autoClearTime: Double = 3.0) -> UIWindow{
...
class SwiftNotice: NSObject {
    ...
    @discardableResult
    static func noticeOnStatusBar(_ text: String, autoClear: Bool, autoClearTime: Double) -> UIWindow{
        let frame = UIApplication.shared.statusBarFrame
        let window = UIWindow()
        window.backgroundColor = UIColor.clear
        let view = UIView()
        view.backgroundColor = UIColor.orange// UIColor(red: 0x6a/0x100, green: 0xb4/0x100, blue: 0x9f/0x100, alpha: 1)
    ...
    @discardableResult
    static func showNoticeWithText(_ type: NoticeType,text: String, autoClear: Bool, autoClearTime: Double) -> UIWindow {
